...
&emsp;🟦 **CRYPTOGRAPHY**❤️\
&emsp;&emsp;🐚 [qsh](https://github.com/xtaci/qsh) - A Quantum-Resistant remote shell built on QPP(encryption) , HPPK(authentication) and HMAC(authenticity). \
...
&emsp;&emsp;🈳️ [budda](https://github.com/xtaci/buddha) - ☸️ My personal collection of Buddhism materials.📿 \
